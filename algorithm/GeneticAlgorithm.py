...
class GeneticAlgorithm:
    def initAlgorithm(self, prototype, numberOfChromosomes=100, replaceByGeneration=80, trackBest=5):
    ...
    def run(self, maxRepeat=9999, minFitness=0.99):
        ...
        while 1:
            ...
            if currentGeneration % 1000==0:
                html_result = HtmlOutput.getResult(self.result)
                temp_file_path = "/data/students/leo/mex/GASchedule.py/output/GaSchedule_latest2.html"
                # print(temp_file_path)
                writer = codecs.open(temp_file_path, "w", "utf-8")
                writer.write(html_result)
                # print("file written")
                writer.close()
                # joblib.dump(self.result, "/data/students/leo/mex/GASchedule.py/output/GaSchedule_latest.pkl")
    def __str__(self):
